...
export type Sale = {
  ...
  createdAt: string;
  // Optionele overschrijving (formaat "YYYY-MM-DD", Brussel-tijd) voor welke
  // dag deze verrichting toont in de Cash-dagontvangsten. Wordt gebruikt als
  // de kassa pas een andere dag afgerond werd dan de afspraak zelf.
  // createdAt blijft altijd het echte afrondingsmoment, puur ter info/audit.
  cashDate?: string;
};
